 ...
 * Use the {@link MejorasToque#newInstance} factory method to
...
public class MejorasToque extends Fragment {
    ...
    public static MejorasToque newInstance(String param1, String param2) {
        MejorasToque fragment = new MejorasToque();
